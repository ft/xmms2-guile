...
;; TODO: The IO functions shouldn't just accept bytevectors and lists of
;; bytevectors, but arbitrarily nested structures as long as the atoms in these
;; structures are bytevectors. Doing so allows us not having to flatten the
;; data generated by the complex-data serializers.
